...
export class PessoasService {
  ...
  guardarPessoas(nome:string, matricula:number, salario:number, cargo:string,especializacao:string){
    return this.http.get('http://localhost/phpCrud/salvar.php?nome='+nome+'&matricula='+matricula+'&salario='+salario+'&cargo='+cargo+'&especializacao='+especializacao+'');
  }
  ...
  editarPessoas(nome:string, matricula:number, salario:number, cargo:string,especializacao:string){
    return this.http.get('http://localhost/phpCrud/editar.php?nome='+nome+'&matricula='+matricula+'&salario='+salario+'&cargo='+cargo+'&especializacao='+especializacao+'&id'+this.id);
  }
}
